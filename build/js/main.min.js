...
/*!***************************!*\
  !*** ./js/const/const.js ***!
  \***************************/
/*! exports provided: viewportLg */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "viewportLg", function() { return viewportLg; });
var viewportLg = '(max-width:1023px)';
...
/* harmony import */ var _modules_document_listeners__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/document-listeners */ "./js/modules/document-listeners.js");
...
Object(_modules_document_listeners__WEBPACK_IMPORTED_MODULE_3__["addListeners"])();

/***/ }),

/***/ "./js/modules/animate-content-blocks.js":
/*!**********************************************!*\
  !*** ./js/modules/animate-content-blocks.js ***!
  \**********************************************/
/*! exports provided: addContentAnimation, addSvgAnimation, addEnterClickAnimation, addTextAnimation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addContentAnimation", function() { return addContentAnimation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addSvgAnimation", function() { return addSvgAnimation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addEnterClickAnimation", function() { return addEnterClickAnimation; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addTextAnimation", function() { return addTextAnimation; });
var loader = document.querySelector('.loader');
var textContent = document.querySelector('h1');
var wrapperContent = document.querySelector('.wrapper-content');
var addContentAnimation = function addContentAnimation() {
  wrapperContent.classList.add('wrapper-content--active');
};
var addSvgAnimation = function addSvgAnimation() {
  loader.querySelector('svg').classList.add('active');
};
var addEnterClickAnimation = function addEnterClickAnimation() {
  loader.querySelectorAll('.loader__enter').forEach(function (element) {
    return element.classList.remove('loader__enter--inactive');
  });
};
var addTextAnimation = function addTextAnimation() {
  textContent.classList.add('wrapper-content__text');
};

/***/ }),

/***/ "./js/modules/animate-dino-container.js":
/*!**********************************************!*\
  !*** ./js/modules/animate-dino-container.js ***!
  \**********************************************/
/*! exports provided: addDinoAnimation */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addDinoAnimation", function() { return addDinoAnimation; });
/* harmony import */ var _animate_content_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animate-content-blocks */ "./js/modules/animate-content-blocks.js");

var containerDino = document.querySelector('.wrapper-content__dino');
var addDinoAnimation = function addDinoAnimation(evt) {
  if (evt.target.tagName !== 'svg' && evt.target.tagName !== 'path' || evt.target.closest('svg') && evt.target.closest('svg').classList.length !== 0) {
    ...
    Object(_animate_content_blocks__WEBPACK_IMPORTED_MODULE_0__["addTextAnimation"])();
  }
};

/***/ }),

/***/ "./js/modules/animate-loader.js":
/*!**************************************!*\
  !*** ./js/modules/animate-loader.js ***!
  \**************************************/
/*! exports provided: onLoadEvent, addApparanceAnimationToLoader */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onLoadEvent", function() { return onLoadEvent; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "addApparanceAnimationToLoader", function() { return addApparanceAnimationToLoader; });
/* harmony import */ var _animate_content_blocks__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animate-content-blocks */ "./js/modules/animate-content-blocks.js");
/* harmony import */ var _utils_utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../utils/utils */ "./js/utils/utils.js");
/* harmony import */ var _const_const__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../const/const */ "./js/const/const.js");
/* harmony import */ var _animate_dino_container__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./animate-dino-container */ "./js/modules/animate-dino-container.js");
...
var addApparanceAnimationToLoader = function addApparanceAnimationToLoader() {
  loader.classList.add('loader--active');
  setTimeout(_animate_content_blocks__WEBPACK_IMPORTED_MODULE_0__["addSvgAnimation"], 0);
  setTimeout(_animate_content_blocks__WEBPACK_IMPORTED_MODULE_0__["addEnterClickAnimation"], 1500);
};

var onLoadEvent = function onLoadEvent(evt) {
  if (window.matchMedia(_const_const__WEBPACK_IMPORTED_MODULE_2__["viewportLg"]).matches && evt.target.tagName !== 'svg' && evt.target.tagName !== 'path') {
    loader.classList.add('loader--out');
    containerDino.classList.add('wrapper-container__in');
    containerDino.addEventListener('click', _animate_dino_container__WEBPACK_IMPORTED_MODULE_3__["addDinoAnimation"]);
    header.addEventListener('click', _animate_dino_container__WEBPACK_IMPORTED_MODULE_3__["addDinoAnimation"]);
    loader.removeEventListener('click', onLoadEvent);
  } else {
    if (Object(_utils_utils__WEBPACK_IMPORTED_MODULE_1__["isEnterEvent"])(evt)) {
      loader.classList.add('loader--out');
      Object(_animate_content_blocks__WEBPACK_IMPORTED_MODULE_0__["addContentAnimation"])();
...
/***/ "./js/modules/document-listeners.js":
/*!******************************************!*\
  !*** ./js/modules/document-listeners.js ***!
  \******************************************/
...
/* harmony import */ var _animate_loader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animate-loader */ "./js/modules/animate-loader.js");
/* harmony import */ var _const_const__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../const/const */ "./js/const/const.js");


var loader = document.querySelector('.loader');
var addListeners = function addListeners() {
  Object(_animate_loader__WEBPACK_IMPORTED_MODULE_0__["addApparanceAnimationToLoader"])();

  if (window.matchMedia(_const_const__WEBPACK_IMPORTED_MODULE_1__["viewportLg"]).matches) {
    loader.addEventListener('click', _animate_loader__WEBPACK_IMPORTED_MODULE_0__["onLoadEvent"]);
  } else {
    document.addEventListener('keydown', _animate_loader__WEBPACK_IMPORTED_MODULE_0__["onLoadEvent"]);
  }
};
...
/*!***************************!*\
  !*** ./js/utils/utils.js ***!
  \***************************/
/*! exports provided: isEnterEvent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "isEnterEvent", function() { return isEnterEvent; });
var isEnterEvent = function isEnterEvent(evt) {
